...
import logo from './img/logoko.png';
    ...
    return (
      <div className="App" style={{backgroundImage:`url(${background})`}}>
          <div className="page">
            ...
            <div className="head">
              <Upload {...props}>
                <Button ghost className="button1" size="large">
                  <Icon type="upload" /> 上传历史患者信息表
                </Button>
              </Upload>
              <Button ghost className="button2" size="large" onClick={this.showDrawer}>构建调度表</Button>
            </div>
            <Drawer
              title="配置信息"
              placement="right"
